...
if (answerPin.pin === mypin) {
    ...
    if (answerDisplay.operator === "withdraw") {
        ...
        if (ansAmount.amount > myAmount) {
            ...
            console.log(chalk.green(`Withdrawal successful. Your remaining balance is $${myAmount}`));
        }
    }
        ...
        console.log(chalk.blackBright(`Fast cash withdrawal successful. Your remaining balance is $${myAmount}`));
